        ...
        <div className="md:w-10/12 mx-auto">
            ...
            <div className="bg-[#F4F3F0] md:p-10 p-4">
                ...
                <form className="space-y-4">
                    ...
                    <div className="flex gap-4">
                        <div className="form-control w-1/2">
                            <label className="label">
                                <span className="label-text text-2xl font-rancho">Cofee Name</span>
                            </label><br />
                            <label className="input-group">
                                <input type="text" name="cofee"  className="input input-bordered w-full" placeholder="Coffee Name" />
                            </label>
                        </div>
                        <div className="form-control w-1/2">
                            <label className="label">
                    ...
                    <input type="submit" value="Add Coffee" className="btn bg-[#D2B48C] w-full text-2xl font-rancho" />
                </form>
            </div>
        </div>
    );
